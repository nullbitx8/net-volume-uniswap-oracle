...
import {NetVolumeOracleV2} from "../src/NetVolumeOracleV2.sol";
...
contract TestNetVolumeOracleV2 is Test, Deployers {
    ...
    function setUp() public {
        ...
        hook = NetVolumeOracleV2(address(flags));
    ...
    function testAfterInitializeState() public {
        NetVolumeOracleV2.ObservationState memory observationState = hook.getState(key);
